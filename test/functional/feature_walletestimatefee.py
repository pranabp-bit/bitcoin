...
class EstimateFeeTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        for _ in range(2):
            ...
            check_estimates(w1, self.nodes[1])
        ...
        self.log.info("Estimates after emptying mempools")
        check_estimates(w1, self.nodes[1])

        # check that the feerate is equal to the mempoolminfee when mempoolminfee is higher than the estimatesmartfee
        ...
        check_estimates(w2, self.nodes[1])
